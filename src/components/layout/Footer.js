        ...
        <footer className={styles.footer}>
            <div className={styles.footerItems}>
                ...
                <ul className={styles.social_list}>
                    ...
                    <li>
                        <a className={styles.whatsApp} href='https://wa.me/554133442029' target='_blank' rel="noopener noreferrer">
                            <FaWhatsapp/>
                        </a>
            ...
            <p className={styles.copy_right}>&copy; 2024 <span>Croma Films</span></p>
        </footer>
    )
}
